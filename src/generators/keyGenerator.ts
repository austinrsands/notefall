import {
  ...
  TOP_CORNER_RADIUS_TO_WHITE_KEY_WIDTH_RATIO,
  BOTTOM_CORNER_RADIUS_TO_WHITE_KEY_WIDTH_RATIO,
  KEY_OFFSETS,
  MIDDLE_C_NOTE,
...
const generateKeys = (
  ...
  for (let note = range.min; note <= range.max; note++) {
    ...
    const topCornerRadius =
      keyWidth * TOP_CORNER_RADIUS_TO_WHITE_KEY_WIDTH_RATIO;
    const bottomCornerRadius =
      keyWidth * BOTTOM_CORNER_RADIUS_TO_WHITE_KEY_WIDTH_RATIO;
