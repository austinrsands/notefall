...
export const WHITE_KEY_SPACE_TO_WIDTH_RATIO = 1 / 20;
export const TOP_CORNER_RADIUS_TO_WHITE_KEY_WIDTH = 1 / 16;
export const BOTTOM_CORNER_RADIUS_TO_WHITE_KEY_WIDTH = 1 / 8;
